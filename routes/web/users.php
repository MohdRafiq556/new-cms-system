...
Route::middleware(['role:admin', 'auth'])->group(function() {
    ...
    Route::put('/users/role{user}/attach', [App\Http\Controllers\UserController::class, 'attach'])->name('user.role.attach');

    Route::put('/users/role{user}/detach', [App\Http\Controllers\UserController::class, 'detach'])->name('user.role.detach');
});
